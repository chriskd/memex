...
SUPPORTED_COMMANDS = {
    ...
    "append": {"required": [], "positional": ["title"]},
...
class ParsedCommand:
    ...
    operation: str  # add, update, search, get, delete, append
...
async def execute_append(cmd: ParsedCommand) -> dict:
...
async def run_batch(
    ...
    for index, command in enumerate(commands):
        ...
        if success:
            ...
            failed += 1
            # result is a dict with 'error', 'code', and 'message' keys
